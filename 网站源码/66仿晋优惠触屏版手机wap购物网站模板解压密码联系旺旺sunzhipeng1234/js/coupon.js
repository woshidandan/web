...
var quercoupon = function(hotOrPrice){
	...
	document.forms[0].action="mu-mobi/couponpublish/queryCoupon.action"+jssessionid+"@hotOrPrice="+hotOrPrice+"&cityLabelid="+cityLabelid+"&pgpageno="+pgpageno+"&cityLabelParentID="+cityLabelParentID+"&industryLabelid="+industryLabelid+"&industryLabelParentID="+industryLabelParentID;
	document.forms[0].submit();
}
var comment = function (loginUrl) {
	...
	var options = 
    {
		    url:"mu-mobi/couponpublish/savaComment.action"+jssessionid,
...
var favorite = function (couponId,loginUrl) {
	var options = 
    {
		    url:"mu-mobi/couponpublish/saveFavorite.action"+jssessionid,
		    data: {'couponID':couponId,'channels':2},
			dataType:'json',
			type:'post',
			error:function(a,b){
...
var cancelFavorite = function(couponId,loginUrl){
	var options = 
    {
		    url:"mu-mobi/couponpublish/cancelFavorite.action"+jssessionid,
		    data: {'couponID':couponId},
			dataType:'json',
			type:'post',
			error:function(a,b){
...
var getLikeCoupon = function (couponId) {
	var options = 
    {
		    url:"mu-mobi/couponpublish/getLikeCoupon.action"+jssessionid,
		    data: {'couponID':couponId},
			dataType:'json',
			type:'post',
			error:function(a,b){
...
//jQuery.ajax({
   ...
   //});
	var options = 
    {
		    url:"mu-mobi/couponpublish/getPopularCoupon.action"+jssessionid,
			dataType:'json',
			type:'post',
			error:function(a,b){
...
var getRecommendedCoupon = function () {
	...
	var options = 
    {
		    url:"mu-mobi/couponpublish/getRecommendedCoupon.action"+jssessionid,
			dataType:'json',
			type:'post',
			error:function(a,b){
		//console.log("查询热门优惠失败！");
...
var likeCoupon = function(data){
	...
	if(data!=null){
		...
		likeCoupon += "<li><p><a href='mu-mobi/couponpublish/queryCouponByID.action"+jssessionid+"@couponID="+this.couponId+"'><img style='width:196px;height:126px;' src='mupublish/image@imgName="+this.iconPath+"' /></a></p><p class='success_title_b'><a href='#'>"+this.title+"</a></p></li>";
	});
...
var popularCoupon = function(data){
	...
	if(data!=null){
		$(data.popularCoupon).each(function (index){
			...
			"<p><a href='mu-mobi/couponpublish/queryCouponByID.action"+jssessionid+"@couponID="+this.couponId+"'><img style='width:186px;height:104px;' src='mupublish/image@imgName="+this.iconPath+"' /></a></p>" +
