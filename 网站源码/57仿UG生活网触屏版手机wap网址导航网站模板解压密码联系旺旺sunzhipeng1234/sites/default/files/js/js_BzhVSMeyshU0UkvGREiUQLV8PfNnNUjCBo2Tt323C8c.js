...
jQuery(function(){
	jQuery("#front-news  .title").css("cursor","pointer").hover(
		function(){
			jQuery("#front-news .news-term").hide();
			jQuery("#front-news .more").hide();
			jQuery("#front-news .news-term").eq(jQuery(this).index("#front-news .title")).show();
			jQuery("#front-news .more").eq(jQuery(this).index("#front-news .title")).show();
		},
		function() {
			jQuery("#front-news .news-term").hide();
			jQuery("#front-news .more").hide();
	...
	);        // front page index categories nav hover effects    jQuery(".index_fenlei").hover(                function(){            jQuery(".ulxia").hide();            jQuery("#front-banner img").hide();            jQuery(".ulxia").eq(jQuery(this).index(".index_fenlei")).show();            jQuery("#front-banner img").eq(jQuery(this).index(".index_fenlei")).show();            jQuery("#mainmenu ul li a.active").removeClass().addClass("active").addClass("mainmenu_li_active" + jQuery(this).index(".index_fenlei"));        },                function(){}        );
});;
  jQuery(function(){
